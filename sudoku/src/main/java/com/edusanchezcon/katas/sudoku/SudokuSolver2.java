...
public class SudokuSolver2 {
    ...
    public SudokuSolver2(SudokuBoard board){
        this(board, 1, true);
    }

    public SudokuSolver2(SudokuBoard board, int recursion){
        this(board, recursion, false);
    }

    public SudokuSolver2(SudokuBoard board, int recursion, boolean isRoot){
